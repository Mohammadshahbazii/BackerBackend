...
namespace Backer.Infrastructure.Migrations
{
    ...
    [Migration("20250513081028_AddTelePhonesTable")]
    partial class AddTelePhonesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backer.Core.Entities.AccessGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backer.Core.Entities.JobsAccess", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backer.Core.Entities.SoftwareVersion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backer.Core.Entities.Telephone", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TellNumber");

                    b.ToTable("Telephones");
                });

            modelBuilder.Entity("Backer.Core.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backer.Core.Entities.AccessGroup", b =>
                {
                    b.HasOne("Backer.Core.Entities.AccessGroup", "ParentGroup")
                        .WithMany()
            ...
            modelBuilder.Entity("Backer.Core.Entities.JobsAccess", b =>
                {
                    b.HasOne("Backer.Core.Entities.AccessGroup", "AccessGroup")
                        .WithMany()
            ...
            modelBuilder.Entity("Backer.Core.Entities.SoftwareVersion", b =>
                {
                    b.HasOne("Backer.Core.Entities.Software", "Software")
                        .WithMany()
            ...
            modelBuilder.Entity("Backer.Core.Entities.User", b =>
                {
                    b.HasOne("Backer.Core.Entities.AccessGroup", "Group")
                        .WithMany()
                    ...
                    b.HasOne("Backer.Core.Entities.Region", "Region")
                        .WithMany()
